...
public class HW4 {
    ...
    public static int playerPower = 30;
    ...
    public static void createMap() {
        ...
        System.out.println("Creat map [" + mapWidth + "x" + mapHeight + "]");
    ...
    public static void spawnPlayer() {
        ...
        System.out.println(playerName + "has spawn in [" + playerPosX + ":" + playerPosY + "L");
    ...
    public static void spawnCoins (char item){
        int itemCount = getFreeCells() /2;
        if (item == enemy){
            enemyHealth=randomValue(enemyValueMin, enemyValueMax);
            enemyPower=randomValue(enemyValueMin,enemyValueMax);
        ...
        for (int i=1; i<= itemCount; i++){
            ...
            invisibleMap[itemPosY][itemPosX]=enemy;
        }
        System.out.println(("Enemy count: " + itemCount + " .HP=" + enemyHealth + ", PWR= " + enemyPower));
    ...
    public static boolean isValidPlayerMove(int lastX, int lastY, int nextX, int nextY) {
        if (isCellValid(nextX, nextY)) {
            ...
            System.out.println(playerName + "has move to [" + nextY + ":" + nextX + "J");
            return true;
        } else {
            System.out.println(playerName + "move to [" + nextY + ":" + nextX + "J invalid");
            playerPosX = lastX;
            playerPosY = lastY;
            return false;
        }
    ...
    public static void battle(int x, int y) {
        ...
        while (isPlayerAlive() && currentEnemyHealth > 0) {
            ...
            System.out.println("PLayerHR: " + playerHealth + " PlayerAtk:" + enemyPower);
            System.out.println("Enemy: " + currentEnemyHealth + " EnemyAtk: " + enemyPower);
            currentEnemyHealth -= playerPower;
            System.out.println("Player give damage to Player. Player HP is " + playerHealth);
